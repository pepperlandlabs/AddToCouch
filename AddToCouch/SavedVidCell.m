...
-(void)deleteAction {
    if ([self.cellDelegate respondsToSelector:@selector(swipeTableViewCellDidDelete:)]) {
        [self.cellDelegate swipeTableViewCellDidDelete:self];
    }
}
